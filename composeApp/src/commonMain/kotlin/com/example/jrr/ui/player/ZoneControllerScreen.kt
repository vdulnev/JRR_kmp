                ...
                Surface(
                    ...
                    Row(
                        ...
                        Column(modifier = Modifier.weight(1f)) {
                            ...
                            if (zone.isDLNA) {
                                Text("DLNA Renderer", style = MaterialTheme.typography.bodySmall, color = MaterialTheme.colorScheme.onSurfaceVariant)
                            }
                        }

                        if (isActive) {
                            Icon(Icons.Default.Link, contentDescription = "Active", tint = MaterialTheme.colorScheme.primary)
                        }
                    }
                }
            }
